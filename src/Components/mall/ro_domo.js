...
class RoDomo extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="container ro_product3 my-5">
        <div className="row">
          <h3 className="text-center rb-session-title mt-2">推薦女裝商品</h3>
                ...
                <div className="product-grid3">
                  <div className="product-image3 m-2">
                    ...
                    <ul className="social">
                      ...
                      <li>
                        <Link to="#" title="加入購物車" className="jj-link-icon" > 
                  ...
                  <div className="product-content">
                    <h3 className="title">
                      <Link to="#" href="">{products.proName}</Link>
                    </h3>
                    <div class="price">
                      ${products.proPrice}
