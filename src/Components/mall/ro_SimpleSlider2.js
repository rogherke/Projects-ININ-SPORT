...
export default class SimpleSlider2 extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div className="background-label rb-mobile-block">
          <div className="rb-long-bg-h">
            <div className="rb-long-bg" />
                  ...
                  <Slider {...settings}>
                    {this.props.products.map(products => (
                        ...
                        <div
                          ...
                          key={products.proSid}
                          title={products.proName}
                        >
                          <div className="product-grid3">
                            <div className="product-image3 m-2">
                              <Link
                                to={`/store/productdetail/${products.proSid}`}
                              >
                                <img
