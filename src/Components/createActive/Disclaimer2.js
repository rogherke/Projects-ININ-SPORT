          ...
          <div className="container rb-z">
            <div className="row mb-4">
              ...
              <div className="container col-12 mt-3 rb-block-w py-3 px-3 rb-logIn">
                <p>
                  1.
                  ININI事業股份有限公司（以下簡稱「ININ」）係依據本服務條款提供服務。當會員完成會員註冊手續、或開始使用本服務時，即表示已閱讀、瞭解並同意接受本服務條款之所有內容。瑪樂愛迪有權於任何時間修改或變更本條款之內容，並公佈於本服務網頁，且不另行通知個別使用者，建議請隨時注意條款修改或變更。若有違反本服務條款時，瑪樂愛迪得隨時依據相關規則暫停或終止您使用本服務，不另行通知。會員於任何修改或變更後繼續使用本服務，視同已閱讀、瞭解並同意接受該等修改或變更。如果不同意本約定書內容，請勿使用本服務。
                  2.
