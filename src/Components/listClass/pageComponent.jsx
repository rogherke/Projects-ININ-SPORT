    ...
    return( 
         <div>
            ...
            <div className="rightDiv">
                 總共<span className="num-total">{_this.props.total}</span>堂課，  共 <span className="num-total">             {_this.props.totalPage}</span>頁，到第  <input type="text" value={_this.props.goValue} onChange=   {this.props.switchChange.bind(this)} />頁 
              </div>  
            </div>        
        </div>       
 )   
