        ...
        return (
            <React.Fragment>
                <div className="form-group d-flex justify-content-center align-items-center rb-claSearch">
                    ...
                    <select value={this.state.city} onChange={this.handleChange1} className="form-control" id="city" name="claSport">
                        <option>* 選擇城市 </option>
                    ...
                    <select value={this.state.sport} onChange={this.handleChange2} className="form-control" id="sport" name="claSport">
