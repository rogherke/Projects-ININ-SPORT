...
// var mailTransport = nodemailer.createTransport("smtps:// credentials.gmail.user:"+encodeURIComponent(' credentials.gmail.password#123') + "@smtp.gmail.com:465"); 
...
//     from: 'Meadowlark Travel <chenwei.he.tw@gmail.com>',
//     to: 'Cythilya <chenwei.he.tw@gmail.com>',
//     subject: 'Hi :)',
...
var options = {
    //寄件者
    from: 'chenwei.he.tw@gmail.com',
    //收件者
    to: 'chenwei.he.tw@gmail.com', 
    //副本
    cc: 'chenwei.he.tw@gmail.com',
    //密件副本
    bcc: 'chenwei.he.tw@gmail.com',
    //主旨
